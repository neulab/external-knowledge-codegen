# -*- coding: utf-8 -*-
"""
Part of the cppastor library for Java AST manipulation.
...
from cppastor.code_gen import to_source
from cppastor.file_util import code_to_ast
from cppastor.node_util import (allow_ast_comparison, dump_tree,
