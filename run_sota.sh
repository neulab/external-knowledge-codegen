...
#
#python exp.py --mode test --load_modelsaved_models/conala/${model_name} --beam_size 15 --test_file $test_file --evaluator conala_evaluator --save_decode_to decodes/conala/sota.test.decode --decode_max_time_step 100
