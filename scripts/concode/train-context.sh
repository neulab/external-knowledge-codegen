...
logs_dir="logs/concode_context"
model_dir="saved_models/concode_context"
decodes_dir="decodes/concode_context"
data_dir="data/concode_context"
...
python -u exp.py \
    ...
    --root_production "typedeclaration,MethodDeclaration" 2>&1 | tee ${logs_dir}/${model_name}.log

. scripts/concode/test.sh ${model_dir}/${model_name}.bin 2>&1 | tee -a ${logs_dir}/${model_name}.log
